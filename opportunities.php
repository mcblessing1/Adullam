...
<head>
	...
	<title>Cave Adullam | Opportunities</title>
	...
	<link rel="stylesheet" href="css/opportunities-style.css">
...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-8" style="justify-content: flex-start;">
				<div class="">
			...
			<div class="col-md-4">
				<div class="row">
					<div class="col-md" style="justify-content: flex-start;">
						<div class="">
							<img class="text-center img-fluid" src="http://via.placeholder.com/650x500" alt="">
						</div>
