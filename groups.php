...
<head>
	...
	<title>Cave Adullam | Interest Groups</title>
	...
	<div class="">
		<div class="">
			...
			<ul class="nav nav-pills nav-pills-ul" role="tablist">
				<li class="nav-item">
					<a class="nav-link nav-pills-ul-a active" data-toggle="pill" href="#groups">Groups</a>
				</li>
				<li class="nav-item">
					<a class="nav-link nav-pills-ul-a" data-toggle="pill" href="#members">Members' Profile</a>
				</li>
			</ul>
